...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=27720ec5-c721-4278-8c33-2ba9b48f5ee9&pack=zh-tw&edition=core%3Bprofessional&aria2=2"
if [ $? != 0 ]; then
