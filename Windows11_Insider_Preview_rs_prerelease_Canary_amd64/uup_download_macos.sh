...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=ab907d94-05ad-4746-bb1b-111a2be79054&pack=zh-tw&edition=core%3Bprofessional&aria2=2"
if [ $? != 0 ]; then
