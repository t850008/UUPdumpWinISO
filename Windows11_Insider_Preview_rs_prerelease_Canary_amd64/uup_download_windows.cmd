@echo off
:: Generated on 2026-07-28 01:50:47 GMT
...
:START_PROCESS
title 29634.1000_amd64_zh-tw_multi_e641ee6e download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=e641ee6e-2254-41bd-8b0a-1f82f298818f&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
