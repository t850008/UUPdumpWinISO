@echo off
:: Generated on 2026-06-26 21:38:23 GMT
...
:START_PROCESS
title 29617.1000_amd64_zh-tw_multi_f7fcb055 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=f7fcb055-e79b-4095-a4b1-2cea9a32ba4d&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
