@echo off
:: Generated on 2026-06-27 06:05:39 GMT
...
:START_PROCESS
title 28120.2315_amd64_zh-tw_multi_c556f7f6 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=c556f7f6-d3b3-40a7-a654-f864208077de&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
