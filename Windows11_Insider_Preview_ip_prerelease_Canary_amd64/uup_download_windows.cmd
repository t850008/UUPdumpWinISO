@echo off
:: Generated on 2026-08-27 00:10:42 GMT
...
:START_PROCESS
title 28120.2760_amd64_zh-tw_multi_c33fa37f download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=c33fa37f-afea-400a-ac98-b9e22004ab5f&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
