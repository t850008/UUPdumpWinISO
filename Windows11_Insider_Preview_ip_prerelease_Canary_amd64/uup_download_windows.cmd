@echo off
:: Generated on 2026-09-01 01:19:06 GMT
...
:START_PROCESS
title 28120.2824_amd64_zh-tw_multi_8cc32347 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=8cc32347-8fd4-4cd7-b705-f0c5a772dd71&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
