@echo off
:: Generated on 2026-08-01 06:31:09 GMT
...
:START_PROCESS
title 28120.2630_amd64_zh-tw_multi_973afe13 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=973afe13-857e-44d3-9dd3-65f44ba2bdf1&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
