@echo off
:: Generated on 2026-07-22 05:02:31 GMT
...
:START_PROCESS
title 28120.2387_amd64_zh-tw_multi_790a7ab6 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=790a7ab6-e2ea-44c7-aa99-62069176a037&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
