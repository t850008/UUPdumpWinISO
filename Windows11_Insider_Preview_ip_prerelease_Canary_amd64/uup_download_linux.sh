...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=693744e6-e75c-486b-abf6-5f2c2854f0c3&pack=zh-tw&edition=core%3Bprofessional&aria2=2"
if [ $? != 0 ]; then
