...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=5b2289bf-2e1a-4e85-a716-8263feeb3fe1&pack=zh-tw&edition=core%3Bprofessional&aria2=2"
if [ $? != 0 ]; then
