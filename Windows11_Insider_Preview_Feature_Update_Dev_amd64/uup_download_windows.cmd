@echo off
:: Generated on 2026-07-07 12:52:14 GMT
...
:START_PROCESS
title 26300.8772_amd64_zh-tw_multi_23b8b945 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=23b8b945-cad8-41db-9925-72a522fedffc&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
