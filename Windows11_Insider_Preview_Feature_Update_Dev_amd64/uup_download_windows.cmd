@echo off
:: Generated on 2026-05-08 21:58:48 GMT
...
:START_PROCESS
title 26300.8376_amd64_zh-tw_multi_575c89c3 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=575c89c3-9ce4-4dfb-bba0-0788e767097f&pack=neutral&edition=app&aria2=2"
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=575c89c3-9ce4-4dfb-bba0-0788e767097f&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
