@echo off
:: Generated on 2026-06-19 22:20:48 GMT
...
:START_PROCESS
title 26300.8697_amd64_zh-tw_multi_3ba75aca download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=3ba75aca-e2a3-469b-893f-f84f9bc23af3&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
