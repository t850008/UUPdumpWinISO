@echo off
:: Generated on 2026-07-21 00:25:51 GMT
...
:START_PROCESS
title 26300.8935_amd64_zh-tw_multi_955e06c5 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=955e06c5-f7ab-4107-b67e-3f4f0b291323&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
