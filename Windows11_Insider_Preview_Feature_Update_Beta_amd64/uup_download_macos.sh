...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=d7cd226f-dc7e-4edf-b2ec-bbffc7b975a0&pack=zh-tw&edition=core%3Bprofessional&aria2=2"
if [ $? != 0 ]; then
