@echo off
:: Generated on 2026-09-26 00:45:00 GMT
...
:START_PROCESS
title 26220.9568_amd64_zh-tw_multi_4499d4f9 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=4499d4f9-5b37-4ef3-be5a-1f14796e52a9&pack=neutral&edition=app&aria2=2"
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=4499d4f9-5b37-4ef3-be5a-1f14796e52a9&pack=zh-tw&edition=core%%3Bprofessional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
