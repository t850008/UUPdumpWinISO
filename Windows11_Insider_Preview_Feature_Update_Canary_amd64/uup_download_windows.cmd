@echo off
:: Generated on 2026-05-29 22:37:27 GMT
...
:START_PROCESS
title 28020.2207_amd64_zh-tw_multi_3bdaf8cc download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=3bdaf8cc-f95e-48da-9c28-47cb3abde61a&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
