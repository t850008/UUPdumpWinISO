@echo off
:: Generated on 2026-06-26 21:38:38 GMT
...
:START_PROCESS
title 28020.2366_amd64_zh-tw_multi_4b6289fc download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=4b6289fc-88b2-476f-b195-7ed904528fa0&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
