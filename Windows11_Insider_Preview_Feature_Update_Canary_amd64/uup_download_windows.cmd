@echo off
:: Generated on 2026-07-21 00:26:09 GMT
...
:START_PROCESS
title 28020.2539_amd64_zh-tw_multi_f02df7b5 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=f02df7b5-d46a-4494-bd2d-1f8a1838e491&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
