@echo off
:: Generated on 2026-08-18 02:28:27 GMT
...
:START_PROCESS
title 28020.2731_amd64_zh-tw_multi_550f25cd download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=550f25cd-469b-4c98-999c-b2d663f9f56a&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
