@echo off
:: Generated on 2026-07-07 12:53:03 GMT
...
:START_PROCESS
title 28020.2380_amd64_zh-tw_multi_146821d9 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=146821d9-a4ad-4941-b438-8252e9cf3e4e&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
