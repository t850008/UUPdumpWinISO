@echo off
:: Generated on 2026-06-12 23:08:23 GMT
...
:START_PROCESS
title 28020.2298_amd64_zh-tw_multi_7984b2f8 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=7984b2f8-39cc-4cce-a5f7-93ec2143a26b&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
