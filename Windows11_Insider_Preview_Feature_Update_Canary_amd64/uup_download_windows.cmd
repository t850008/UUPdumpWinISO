@echo off
:: Generated on 2026-07-31 23:17:45 GMT
...
:START_PROCESS
title 28020.2623_amd64_zh-tw_multi_b7003d33 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=b7003d33-2aee-43be-bcbe-46c9631ad9d5&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
