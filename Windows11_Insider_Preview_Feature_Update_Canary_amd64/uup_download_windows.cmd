@echo off
:: Generated on 2026-06-20 00:21:12 GMT
...
:START_PROCESS
title 28020.2308_amd64_zh-tw_multi_67081123 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=67081123-2436-4e87-b455-d12222ebe016&pack=zh-tw&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
